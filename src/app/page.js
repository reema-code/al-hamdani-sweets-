...
export default function HomePage() {
  return (
    <main>
      ...
      <section className="hero">
        <div className="shell hero-grid">
          <div className="hero-copy">
            <p className="eyebrow">وجهتك المغربية الشاملة في دبي</p>
            <h1>كل ما هو مغربي أصيل، في مكان واحد.</h1>
            <p className="lead">حلويات ومخبوزات، شاي وتوابل، أدوات المطبخ والطواجن، منتجات الحمام المغربي والجمال، وقطع للمنزل والديكور — مختارة بعناية وموصّلة أينما كنت في دبي.</p>
      ...
      <section className="trust-strip"><div className="shell trust-grid">{['منتجات مغربية أصيلة', 'اختيار من كل الفئات', 'توصيل في دبي', 'طلب سهل عبر واتساب'].map((item) => <span key={item}>✦ {item}</span>)}</div></section>
      ...
      <section id="collections" className="section cream">
        <div className="shell">
          <div className="section-head">
            ...
            <p>من مائدة الشاي إلى الحمام المغربي، وصولاً إلى ديكور المنزل — تشكيلة تغطي كل جوانب الحياة المغربية الأصيلة.</p>
          </div>
      ...
      <section id="products" className="section">
        <div className="shell">
          <div className="section-head">
            ...
            <p>من كعب الغزال إلى كأس الشاي الأخضر — القطع التي يطلبها عملاؤنا أكثر من غيرها.</p>
          </div>
      ...
      <section id="hammam" className="section hammam-section">
        <div className="shell split reverse">
          ...
          <div>
            ...
            <p>صابون بلدي أسود، غاسول الأطلس، وزيت الأركان الأصلي المعصور على البارد — منتجات طبيعية 100% مصدرها المغرب، لتجربة حمام مغربي أصيلة في منزلك.</p>
      ...
      <section id="contact" className="section delivery-section">
        <div className="shell delivery-card" style={{ backgroundImage: "url('/images/section-delivery.jpg')" }}>
          ...
          <div className="delivery-copy">
            ...
            <p>اطلب عبر واتساب وسنقوم بتجهيز طلبك وتوصيله بسرعة إلى بابك — أو تفضل بزيارتنا مباشرة.</p>
      ...
      <footer>
        <div className="shell newsletter-row">
          <div>
            ...
            <h2>تعرف أولاً على وصولات المغرب الجديدة</h2>
