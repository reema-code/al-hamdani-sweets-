  ...
  return (
    <main id="top">
      ...
      <nav className="trust-strip" aria-label="روابط المجموعات"><div className="shell trust-grid">{[
        ['حلويات ومخبوزات', '#products'], ['المؤونة والشاي والتوابل', '#products'], ['الطواجن وأطقم الشاي', '#kitchen'], ['الجمال والحمّام', '#hammam']
        ...
        <div className="shell delivery-card" style={{ backgroundImage: "url('/images/section-delivery.jpg')" }}>
          ...
          <div className="delivery-copy">
            ...
            <div className="contact-actions">
              <a className="btn btn-orange" href={whatsappHref}>استفسر عن التوصيل</a>
      ...
      <a className="mobile-whatsapp" href={whatsappHref}>تواصل معنا</a>
    </main>
  );
}
